...
export const metadata: Metadata = {
  ...
  keywords: ["contact Maysan Labs", "software development inquiry", "custom software quote", "enterprise SaaS consultation", "Maysan Labs contact"],
  openGraph: {
    ...
    images: [{ url: ogImage("Contact Maysan Labs", "Start your software project with a free consultation. Custom development by Maysan Labs."), width: 1200, height: 630, alt: "Contact Maysan Labs" }],
  },
  twitter: {
